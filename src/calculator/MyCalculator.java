 ...
 * Used by: JC Carlo D.G. Quintos
 * Reason: Test case for the two functions: NFactorial and Binary Search
**/
...
public class MyCalculator {
	...
	public int nfactorial(int n){
		...
		for(int i=1;i<=n;i++)		// EDITED: from "i<n" to "i<=n"
			factorial *= i;
		return factorial;
	}
	...
	int binarySearch(int[] a,int x){
		...
		int lower, upper, middle = 0; // variables for positions in the array	// EDITED: from "middle" to "middle = 0"
		...
		return -1;				// EDITED: from "return 1" to "return -1"
	}
}